    ...
    public class Unit : GameElement
    {
        ...
        protected override void UpdateElement(IReadOnlyList<Any> responses)
        {
            ...
            if (Id == id)
            {
                ...
                Hitpoints = responses[6].Unpack<UpObjectDataResult>().Result;
                Order = (UnitOrder)responses[7].Unpack<UpObjectDataResult>().Result;
                NextAttack = TimeSpan.FromMilliseconds(responses[8].Unpack<UpObjectDataResult>().Result);
                Stance = (UnitStance)responses[9].Unpack<UpObjectDataResult>().Result;
                MaxHitpoints = responses[10].Unpack<UpObjectDataResult>().Result;
                Range = responses[11].Unpack<UpObjectDataResult>().Result;
                Speed = responses[12].Unpack<UpObjectDataResult>().Result / 100d;
                Attack = responses[13].Unpack<UpObjectDataResult>().Result;
                MeleeArmor = responses[14].Unpack<UpObjectDataResult>().Result;
                PierceArmor = responses[15].Unpack<UpObjectDataResult>().Result;
                ReloadTime = TimeSpan.FromMilliseconds(responses[16].Unpack<UpObjectDataResult>().Result);
                TrainSiteId = responses[17].Unpack<UpObjectDataResult>().Result;
                Class = (UnitClass)responses[18].Unpack<UpObjectDataResult>().Result;
                CmdId = (CmdId)responses[19].Unpack<UpObjectDataResult>().Result;
                BaseTypeId = responses[20].Unpack<UpObjectDataResult>().Result;
                Carry = responses[21].Unpack<UpObjectDataResult>().Result;
                Garrisoned = responses[22].Unpack<UpObjectDataResult>().Result == 1;
                GarrisonCount = responses[23].Unpack<UpObjectDataResult>().Result;
                FrameDelay = responses[24].Unpack<UpObjectDataResult>().Result;
                TasksCount = responses[25].Unpack<UpObjectDataResult>().Result;
                AttackerCount = responses[26].Unpack<UpObjectDataResult>().Result;
                AttackerId = responses[27].Unpack<UpObjectDataResult>().Result;
                TrainTime = TimeSpan.FromSeconds(responses[28].Unpack<UpObjectDataResult>().Result);
                BlastRadius = responses[29].Unpack<UpObjectDataResult>().Result / 100d;
                BlastLevel = responses[30].Unpack<UpObjectDataResult>().Result;
                ProgressType = responses[31].Unpack<UpObjectDataResult>().Result;
                ProgressValue = responses[32].Unpack<UpObjectDataResult>().Result;
                MinRange = responses[33].Unpack<UpObjectDataResult>().Result;
                TargetTime = TimeSpan.FromMilliseconds(responses[34].Unpack<UpObjectDataResult>().Result);
                Heresy = responses[35].Unpack<UpObjectDataResult>().Result == 1;
                Faith = responses[36].Unpack<UpObjectDataResult>().Result == 1;
                Redemption = responses[37].Unpack<UpObjectDataResult>().Result == 1;
                Atonement = responses[38].Unpack<UpObjectDataResult>().Result == 1;
                Theocracy = responses[39].Unpack<UpObjectDataResult>().Result == 1;
                Spies = responses[40].Unpack<UpObjectDataResult>().Result == 1;
                Ballistics = responses[41].Unpack<UpObjectDataResult>().Result == 1;
                GatherType = responses[42].Unpack<UpObjectDataResult>().Result;
                LanguageId = responses[43].Unpack<UpObjectDataResult>().Result;
