...
namespace AoE2Lib.Games
{
    ...
    {
        BRITONS = 1, FRANKS, GOTHS, TEUTONS, JAPANESE, CHINESE, BYZANTINES, PERSIANS, SARACENS, TURKS, VIKINGS, MONGOLS, CELTS, SPANISH, AZTECS, MAYANS, HUNS, KOREANS, 
        ITALIANS, INDIANS, INCAS, MAGYARS, SLAVS, PORTUGUESE, ETHIOPIANS, MALIANS, BERBERS, KHMER, MALAY, BURMESE, VIETNAMESE, RANDOM
    }
