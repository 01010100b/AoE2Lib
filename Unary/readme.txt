...
7. When the game is over, click "Stop all players". If you want to restart a new game, go to step 5 again. Note that you can not run multiple games (even restarts) without "Stop all players" and going through step 5 again.